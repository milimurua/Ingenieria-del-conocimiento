...
# Para ello deberás concatenar la primera parte de la frase con el valor que asumirá la variable. Recuerda agregar
# un espacio antes de concatenar la variable al resto del texto.

course = "Ingenieria del conocimiento"
phrase = "Estas estudiando " + course
